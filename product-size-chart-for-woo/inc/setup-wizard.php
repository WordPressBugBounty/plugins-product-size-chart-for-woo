                ...
                <div class="vi-ui segment">
                    <div class="pscw-segment-container active">
                        <select name="" id="pscw-setup-select-position"
                            ...
                            <option value="product_tabs"
                                    selected><?php esc_html_e( 'Product tab', 'product-size-chart-for-woo' ) ?></option>
