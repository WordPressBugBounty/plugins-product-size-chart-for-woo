...
- [Getting Started](https://docs.villatheme.com/?item=woocommerce-product-size-chart)

### Plugin Links

- [Project Page](https://villatheme.com)
- [Documentation](https://docs.villatheme.com/?item=woocommerce-product-size-chart)
...
2. Upload `product-size-chart-for-woo` to the `/wp-content/plugins/` directory
...
== Screenshots ==
1. Custom size chart
2. Size chart icon on single product page
3. Size chart on popup
4. Size chart on product tab

== Changelog ==

2026.08.17 - version 2.1.5
- Updated: Compatible WooCommerce 11.0

2026.06.20 - version 2.1.4
- Updated: VillaTheme support

2026.03.06 - version 2.1.3
- Updated: VillaTheme support

2026.01.13 - version 2.1.2
- Updated: VillaTheme support

2025.09.08 - version 2.1.1
- Fixed: Can not scroll in the homepage on customize

2025.06.12 - version 2.1.0
